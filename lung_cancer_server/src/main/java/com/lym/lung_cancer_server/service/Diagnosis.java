...
public class Diagnosis {
    public Diagnosis(String datePackage)throws IOException, InterruptedException{
        testPython(datePackage);
    }

    public void testPython(String datePackage)throws IOException, InterruptedException{
        String exe = "python";
        String command = "E:\\github-本地\\第六学期\\web数据管理\\lung_cancer_data_processing\\final\\diagnosis.py";
